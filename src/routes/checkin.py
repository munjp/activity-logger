            ...
            if line and ':' in line and not line.startswith('Dealership Addresses'):
                try:
                    ...
                    if len(parts) == 2:
                        ...
                        # Add coordinates for all dealerships (using approximate GTA locations)
                        dealership_coordinates = {
                            'test_site': {'lat': 43.8828, 'lng': -79.4403},  # Richmond Hill area
                            '401_infiniti': {'lat': 43.6532, 'lng': -79.3832},  # Toronto area
                            '401_kia': {'lat': 43.6532, 'lng': -79.3832},  # Toronto area
                            '401_mazda': {'lat': 43.6532, 'lng': -79.3832},  # Toronto area
                            '401_mitsubishi_dixie_mitsubishi': {'lat': 43.5890, 'lng': -79.6441},  # Mississauga area
                            '401_nissan': {'lat': 43.6532, 'lng': -79.3832},  # Toronto area
                            '401_volkswagen': {'lat': 43.6532, 'lng': -79.3832},  # Toronto area
                            'agincourt_mazda': {'lat': 43.7896, 'lng': -79.2620},  # Agincourt area
                            'audi_barrie': {'lat': 44.3894, 'lng': -79.6903},  # Barrie area
                            'audi_queensway': {'lat': 43.6532, 'lng': -79.3832},  # Toronto area
                            'audi_thornhill': {'lat': 43.8071, 'lng': -79.4194},  # Thornhill area
                            'barrie_volkswagen': {'lat': 44.3894, 'lng': -79.6903},  # Barrie area
                            'bmw_aurora': {'lat': 44.0065, 'lng': -79.4504},  # Aurora area
                            'bolton_toyota': {'lat': 43.8771, 'lng': -79.7314},  # Bolton area
                            'frost_gm': {'lat': 43.6532, 'lng': -79.3832},  # Toronto area
                            'markham_acura': {'lat': 43.8561, 'lng': -79.3370},  # Markham area
                            'markham_honda': {'lat': 43.8561, 'lng': -79.3370},  # Markham area
                            'markham_kia': {'lat': 43.8561, 'lng': -79.3370},  # Markham area
                            'meadowvale_honda': {'lat': 43.5890, 'lng': -79.6441},  # Mississauga area
                            'oakville_honda': {'lat': 43.4675, 'lng': -79.6877},  # Oakville area
                            'thorncrest_ford': {'lat': 43.6532, 'lng': -79.3832},  # Toronto area
                            'vaughan_chrysler': {'lat': 43.8361, 'lng': -79.5083}   # Vaughan area
                        }
