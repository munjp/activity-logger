...
def send_to_slack(name, activities, total_metrics, dealership_info=None, checkin_time=None, webhook_url=None):
    ...
    # Use hardcoded webhook URL for team submissions
    slack_webhook_url = "https://hooks.slack.com/services/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"
...
def send_slack_only():
    ...
    # Send to Slack (always enabled with hardcoded webhook)
